        ...
        <div className="od-grid">
          <div className="od-card">
            ...
            <div className="od-row">
              <span className="od-label">Họ và tên</span>
              <span className="od-value">{myOrderDetail?.fullname}</span>
            </div>
            <div className="od-row">
              <span className="od-label">Số điện thoại</span>
              <span className="od-value">{myOrderDetail?.phone}</span>
            </div>
            <div className="od-row">
              <span className="od-label">Địa chỉ</span>
              <span className="od-value">{myOrderDetail?.address}</span>
            </div>
          </div>
          ...
          <div className="od-card">
            ...
            <div className="od-row">
              ...
              <span
                className={`badge ${myOrderDetail?.status === "Chờ xác nhận" ? "badge-pending" : myOrderDetail?.status === "Đã xác nhận" ? "badge-confirmed" : "badge-cancelled"}`}
              >
            ...
            <div className="od-row">
              ...
              <span className="od-value">{myOrderDetail?.paymentMethod}</span>
            </div>
            <div className="od-row">
              <span className="od-label">TT thanh toán</span>
              <span
                className={`badge ${myOrderDetail?.paymentStatus === "Đã thanh toán" ? "badge-paid" : "badge-unpaid"}`}
              >
        ...
        <div className="od-card">
          ...
          <div className="od-total-bar">
            ...
            <span className="od-total-value">
              {myOrderDetail?.totalAmount?.toLocaleString()} VNĐ
            </span>
          </div>
        </div>
